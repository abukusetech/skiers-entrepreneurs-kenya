...
export const metadata: Metadata = {
  title: "Find Talent | SKIERS ENTREPRENEURS KENYA",
  description:
    "Browse services offered by skilled workers across Kenya. Web development, design, cleaning, events, and more.",
};
      ...
      <section className="relative overflow-hidden bg-dark py-16 lg:py-20">
        ...
        <div className="relative container-site">
          <div className="max-w-3xl">
            ...
            >
              Browse services offered by skilled workers across Kenya.
            </p>
          </div>
            ...
            <div className="text-center py-20">
              ...
              <p className="text-text-secondary mb-8 max-w-md mx-auto">
                {q
                  ...
                  : "Be the first to publish a service on SKIERS."}
              </p>
              <Link
                href={q ? "/services" : "/create-service"}
              ...
              >
                {q ? "Browse all services" : "Create a service"}
              </Link>
            </div>
          )}
        </div>
