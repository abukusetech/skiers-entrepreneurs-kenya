...
import {
  ...
  type DeleteOrganizationProfileState,
} from "@/lib/actions/delete-organization-profile";
import { AlertTriangle, Loader2, X } from "lucide-react";

const initialState: DeleteOrganizationProfileState = null;
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-text-secondary leading-relaxed mb-4">
            This deletes your organization profile. Jobs you have posted stay on
            the marketplace but they will no longer be linked to your
        ...
        >
          <div className="bg-white rounded-2xl max-w-md w-full p-6 lg:p-8 shadow-2xl">
            ...
            <p className="text-sm text-text-secondary leading-relaxed mb-5">
              Deleting your organization profile removes it from SKIERS. Jobs
              you have posted stay live but will no longer show your
              organization logo or name. This cannot be undone.
            </p>
