...
} from "@/lib/actions/save-business-profile";
...
const initialState: BusinessProfileState = null;
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Hospitality, retail, beauty"
                  className="w-full h-11 px-4 rounded-md border border-border text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Westlands Business Park"
                  className="w-full h-11 px-4 rounded-md border border-border text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
                />
              </div>
            </div>
        ...
        <section className="pt-6 border-t border-border">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-text-tertiary">
              Documents are used for verification only and are never shown
              publicly.
            </p>
          </div>
        </section>
